...
public class BookTest {
	...
	public static void main(String[] args) {
		...
		+b1.getBookPrice()+"원     "+b1.getBookDiscountRate()+"%    "+b1.getDiscountBookPrice()+"원");
		
		System.out.println(b2.getBookName()+"       "
		+b2.getBookPrice()+"원     "+b2.getBookDiscountRate()+"%    "+b2.getDiscountBookPrice()+"원");
		
		System.out.println(b3.getBookName()+"    "
		+b3.getBookPrice()+"원     "+b3.getBookDiscountRate()+"%    "+b3.getDiscountBookPrice()+"원");
